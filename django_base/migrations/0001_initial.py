...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.CharField(max_length=100, verbose_name='选项名称')),
                ('value', models.TextField(blank=True, default='', verbose_name='选项值')),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='django_base.Contact', verbose_name='联系人')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='contactsetting',
            unique_together=set([('contact', 'key')]),
        ),
        migrations.AlterUniqueTogether(
            name='contact',
